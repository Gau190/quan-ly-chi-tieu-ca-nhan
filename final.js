...
const Dashboard = ({ stats, filteredGroups, filters, setFilters, isBalanceVisible, setIsBalanceVisible, formatVND, isEmpty }) => {
  ...
  )), gIdx !== displayGroups.length - 1 && /* @__PURE__ */ React.createElement("div", { className: "h-px w-auto mx-4 my-1 bg-slate-50" })))))), /* @__PURE__ */ React.createElement("div", { className: "h-[170px] w-full shrink-0" }));
};
